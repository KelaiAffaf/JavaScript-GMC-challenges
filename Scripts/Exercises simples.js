...
for (let index = 0; index < companies.length; index++) {
  ...
  companies[index] = companies[index].toUpperCase();
  
}
console.log(nestedArray(companies));
...
//    countries.push([array[i],array[i].substr(0,3).toUpperCase(),array[i].length])
//   }
//   return countries;
// }
...
let array=[12,35,85,4,78,13,90,45,6,81]
